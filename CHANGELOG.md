...
- Align with `hisi-rf-ws63 0.1.0-alpha.100`, whose v13 resource report accounts
  for the Wi-Fi event-conservation counters and restores all incremental and
  cross-platform consumer builds.
...
- Align the WS63 facade with `hisi-rf-ws63 0.1.0-alpha.97`, including the
  complete hidden resource capability required by the SoftAP plus BLE
  two-board fixture and its explicit station-runner CI contract.
...
- Align the WS63 facade with `hisi-rf-ws63 0.1.0-alpha.94`, including the
  retained coexistence scan candidate and the v12 page-rounded BLE/SLE
  resource contract whose final link is verified on macOS, Linux, and Windows.

## [0.1.0-alpha.103] - 2026-09-01

### Changed

- Align the facade dependency with `hisi-rf-ws63 0.1.0-alpha.92`, including
  the explicit connected Wi-Fi/SLE and SoftAP/SLE composition contracts.
